    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="https://github.com/Airgold3/Securesystem">
                ...
                <div class="sidebar-brand-text mx-3"><b>SecureSystem</b> <sup></sup></div>
            </a>
                             ...
                             <div class="row no-gutters align-items-center">
                                 <div class="col mr-2">
                                     <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                        Users (Total)</div>
                                     <div class="h5 mb-0 font-weight-bold text-gray-800"><?php totaluser($con, $user); ?></div>
                                 </div>
                                 <div class="col-auto">
                             ...
                             <div class="row no-gutters align-items-center">
                                 <div class="col mr-2">
                                     <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                         Admins (Total)</div>
                                     <div class="h5 mb-0 font-weight-bold text-gray-800"><?php totaladmins($con, $user); ?></div>
                                 </div>
                                 <div class="col-auto">
                             ...
                             <div class="row no-gutters align-items-center">
                                 <div class="col mr-2">
                                     <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                         Email (Pending )</div>
                                     <div class="h5 mb-0 font-weight-bold text-gray-800"><?php totalemailnotverified($con, $emailnotverified); ?></div>
                                 </div>
                                 <div class="col-auto">
